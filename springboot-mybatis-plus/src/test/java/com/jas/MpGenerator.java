 ...
 * @author zc
 * @description
 * @create 2018-08-21 20:07
 */
public class MpGenerator {


    private final static String DRIVER_NAME = "com.mysql.jdbc.Driver";
    private final static String URL = "jdbc:mysql://localhost:3306/mp?" 
            + "useUnicode=true&characterEncoding=utf8&allowMultiQueries=true";
    private final static String USERNAME = "root";
    private final static String PASSWORD = "1234";
    private final static String TABLE_PREFIX = "tbl_";
    ...
    public void create() throws InterruptedException {
        ...
        gc.setOutputDir("E:\\workspace\\springboot-mybatis-plus\\src\\main\\java");
